  ...
  <div class="aula-content-section">
    ...
    <div class="toc-container">
      <ul style="list-style: none; padding: 0; font-size: 14px;">
        <li style="margin-bottom: 8px; margin-top: 2px"><a href="#struct">O que é uma Struct?</a></li>
        <li style="margin-bottom: 8px;"><a href="#definir">Como definir uma struct</a></li>
      </ul>
    </div>
            <h2 class="aulas-section-title">Structs em C++</h2>
            <h3 id=struct class="aulas-section-h3">- O que é uma Struct?</h3>
            ...
            <p style="max-width: 80%;">As structs são especialmente úteis quando o utilizador deseja representar um objeto que possui várias propriedades.</p>
            <hr>
        
            <h2 id=definir class="aulas-section-title">Como definir uma struct</h2>
            <p style="max-width: 80%;">Para definir uma struct, utiliza-se a palavra-chave struct, seguida pelo nome da estrutura e um bloco de chaves que contém as variáveis 
...
int main() {
    ...
    return 0;
            ...
            <ul>
                <li style="max-width: 80%;">Definição da Struct: A estrutura Ponto é definida com dois membros: x e y, ambos do tipo int, que representam as coordenadas de um ponto no plano.</li>
                <li style="max-width: 80%;">Instância da Struct: No main, criamos uma instância da estrutura Ponto chamada p1.</li>
                <li style="max-width: 80%;">Atribuição de Valores: Atribuímos valores às coordenadas x e y do ponto p1.</li>
                <li style="max-width: 80%;">Exibição dos Dados: Usamos std::cout para exibir as coordenadas do ponto na tela.</li>
            </ul>
          ...
          <div class="aulas-buttons-container">
            <div class="container text-center">
              <a class="btn btn-secondary me-3" href="aula12.php">Anterior</a>
