...
<div class="aulas-main-content">
  ...
  <div class="toc-container">
    <ul style="list-style: none; padding: 0; font-size: 14px;">
      <li style="margin-bottom: 8px; margin-top: 2px"><a href="#estrutura">Estrutura do Programa</a></li>
      <li style="margin-bottom: 8px;"><a href="#hello">Exemplo Hello World</a></li>
      <li style="margin-bottom: 8px;"><a href="#ponto-virgula">Ponto e Vírgula</a></li>
      <li style="margin-bottom: 8px;"><a href="#blocos">Blocos de Código</a></li>
      <li style="margin-bottom: 8px;"><a href="#comentarios">Comentários</a></li>
    </ul>
  </div>
          ...
          <div class="aulas-row my-5">
            <div class="aulas-col-6 aulas-col-md-6">
              <div class="aulas-feature">
                <h2 id="estrutura" class="aulas-section-title">Estrutura de um Programa C++</h2>
                <p style="max-width: 80%;">
                  Todos os programas em C++ têm uma estrutura base composta por algumas partes principais:
                </p>
                <ul>
                  <li style="max-width: 80%;"><b>Inclusão de Bibliotecas:</b> Normalmente, começa-se o código incluindo bibliotecas que fornecem funcionalidades adicionais que a linguagem não oferece por padrão. A inclusão é feita com o comando #include.</li>
                  <li style="max-width: 80%;"><b>Função main():</b> Todo programa em C++ começa a execução a partir da função main(), que é o ponto de entrada do programa. Esta função pode devolver um valor inteiro (normalmente 0), que indica que o programa terminou com sucesso.</li>
                  <li style="max-width: 80%;"><b>Código dentro da função main():</b> O código que será executado pelo programa é escrito dentro das chaves { } da função main().</li>
                </ul>

                <h4 id="hello" class="aulas-section-h4">Exemplo do código "Hello World"</h4>
  ...
  int main() {
      ...
      return 0;
                ...
                <ul>
                  <li style="max-width: 80%;"><b>#include &lt;iostream&gt;:</b> Inclui a biblioteca de entrada e saída padrão do C++ para permitir o uso de std::cout, que é usado para imprimir na tela.</li>
                  <li style="max-width: 80%;"><b>int main():</b> Define a função principal que será executada quando o programa iniciar.</li>
                  <li style="max-width: 80%;"><b>std::cout << "Hello, World!" << std::endl;:</b> Imprime a string "Olá, Mundo!" seguida por uma nova linha (std::endl).</li>
                  <li style="max-width: 80%;"><b>return 0;:</b> Finaliza a execução da função main() e retorna 0, indicando sucesso.</li>
                </ul>

                <hr>

                <h4 id="ponto-virgula" class="aulas-section-h4">Instruções e Ponto e Vírgula</h4>
                <p style="max-width: 80%;">
  ...
  std::cout << "Valor de a: " << a << std::endl;  // Imprime o valor de a na tela
                ...
                <p style="max-width: 80%;">Aqui, cada linha termina com um ponto e vírgula para indicar que a instrução foi concluída.</p>

                <hr>
                <h4 id="blocos" class="aulas-section-h4">Blocos de código</h4>
                <p style="max-width: 80%;">Blocos de código em C++ são usados para agrupar instruções, especialmente em estruturas de controle como loops e condicionais. 
                Eles são delimitados por chaves { }.</p>
                <ul>
                    <li style="max-width: 80%;"><b>Condicionais:</b> Utilizadas para executar trechos de código com base em uma condição</li>
                    <li style="max-width: 80%;"><b>Loops:</b> Usados para repetir um bloco de código várias vezes</li>
                </ul>
...
if (x > 0) {
    ...
    std::cout << "X não é positivo!" << std::endl;  // se não, este código é executado
                ...
                <ul>
                  <li style="max-width: 80%;"><b>if (x > 0):</b> Verifica se o valor de x é maior que zero.</li>
                  <li style="max-width: 80%;"><b>else:</b> Caso a condição do if não seja satisfeita, o código dentro do bloco else será executado.</li>
                </ul>
...
for (int i = 0; i < 5; i++) {
    std::cout << "Valor de i: " << i << std::endl;  // Imprime os valores de i de 0 a 4
                ...
                <p style="max-width: 80%;">O laço <u>'for'</u> vai executar o código dentro das chaves { } 5 vezes, começando com <u>i</u> igual a 0, até <u>i</u> ser igual a 4. 
                A cada ciclo, o valor de i é incrementado em 1.</p>

                <hr>
                <h4 id="comentarios" class="aulas-section-h4">Comentários</h4>
                <p style="max-width: 80%;">Comentários são usados para explicar o código e não afetam a execução do programa. 
                ...
                <ul>
                    <li style="max-width: 80%;"><b>Comentário de linha única:</b> Usa // para comentar uma linha inteira. Tudo o que vem depois de // na mesma linha será ignorado pelo compilador.</li>
                    <li style="max-width: 80%;"><b>Comentário de várias linhas:</b> Usa /* para iniciar e */ para terminar o comentário, permitindo que o comentário ocupe várias linhas.</li>
                </ul>
