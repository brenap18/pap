      ...
      <div class="aulas-main-content">
        ...
        <div class="toc-container" style="margin-top: 40px;">
          <ul style="list-style: none; padding: 0; font-size: 14px;">
            <li style="margin-bottom: 8px; margin-top: 2px;"><a href="#definicao">O que são Funções?</a></li>
            <li style="margin-bottom: 8px;"><a href="#caracteristicas">Características das Funções</a></li>
            <li style="margin-bottom: 8px;"><a href="#definicao-funcao">Definição de Funções em C++</a></li>
            <li style="margin-bottom: 8px;"><a href="#chamada">Chamada de Funções</a></li>
            <li style="margin-bottom: 8px;"><a href="#exemplo">Exemplo Completo</a></li>
          </ul>
        </div>

        <h2 class="aulas-section-title">Funções em C++</h2>

        <h3 id="definicao" class="aulas-section-h3">- O que são Funções?</h3>
        <p style="max-width: 80%;">
          Funções são blocos de código que executam tarefas específicas e podem ser reutilizados várias vezes ao longo do programa. Elas ajudam a organizar o código, evitando repetição e facilitando a manutenção.
        </p>
        <hr>

        <h2 id="caracteristicas" class="aulas-section-title">Características das Funções</h2>
        <ul>
          <li style="max-width: 80%;"><strong>Tipo de Retorno:</strong> Define que tipo de dado a função vai devolver após a execução (ex: int, void).</li>
          <li style="max-width: 80%;"><strong>Nome:</strong> Identificador da função, usado para chamá-la.</li>
          <li style="max-width: 80%;"><strong>Parâmetros (opcionais):</strong> Variáveis que a função pode receber para operar sobre dados externos.</li>
          <li style="max-width: 80%;"><strong>Corpo da Função:</strong> Bloco de código que contém as instruções a serem executadas.</li>
        </ul>

        <h4 id="definicao-funcao" class="aulas-section-h4">Definição de Funções em C++</h4>
        <p style="max-width: 80%;">
          Para definir uma função em C++, escrevemos o tipo de retorno, o nome da função e os parâmetros entre parênteses, seguidos pelo corpo da função entre chaves.
        </p>
...
int soma(int a, int b) {
    return a + b;
        ...
        <h4 id="chamada" class="aulas-section-h4">Chamada de Funções</h4>
        <p style="max-width: 80%;">
          Para usar a função, chamamos seu nome e passamos os argumentos necessários. O valor retornado pode ser armazenado em uma variável ou usado diretamente.
        </p>
        <div class="code-section">
          <pre><code class="language-c++">
#include &lt;iostream&gt;
...
int main() {
    ...
    std::cout << "Resultado: " << resultado << std::endl; // Exibe o resultado
    return 0;
}
          </code></pre>
        </div>

        <h4 id="exemplo" class="aulas-section-h4">Exemplo Completo</h4>
        <p style="max-width: 80%;">
          Veja um exemplo completo onde definimos uma função para somar dois números, chamamos ela no main e exibimos o resultado.
        </p>
        <div class="code-section">
          <pre><code class="language-c++">
#include &lt;iostream&gt;
    ...
    return 0;
        ...
        <div class="aulas-buttons-container">
          <div class="container text-center">
            <a class="btn btn-secondary me-3" href="aula8.php">Anterior</a>
            <a class="btn btn-secondary" href="aula10.php">Próximo</a>
          </div>
        </div>
