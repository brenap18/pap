    ...
    <form action="contareg.php" method="post">
      <h2 class="login-heading">Register</h2>
        ...
        <div class="login-form-group">
            <label for="full_name" class="login-label">Full Name:</label>
            <input type="text" class="login-input" id="full_name" name="name" placeholder="Full Name" required>
        </div>
        ...
        <div class="login-form-group">
            ...
            <input type="password" class="login-input" id="pwd" name="password" placeholder="Password" required>
        </div>

        <div class="login-form-group">
            <label for="pwd_confirm" class="login-label">Confirm Password:</label>
            <input type="password" class="login-input" id="pwd_confirm" name="password_confirm" placeholder="Confirm Password" required>
        </div>

        <button type="submit" name="login" class="login-btn" style="width: 100%; padding: 12px; background-color: #4b4a8b; color: white; border: none; font-size: 16px; cursor: pointer; border-radius: 4px;">Regista</button>
    </form>
